				...
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<c:choose>
								<c:when
									test="${listOrderDetails ne null && listOrderDetails.size() gt 0}">
										...
										<tr>
											...
											<sec:authorize access="hasRole('ADMIN')">
												...
												<td class="price" data-title="Price"><span>
														${item.unitPrice } </span></td>

												<td class="qty" data-title="Qty">
													<form
														action="${pageContext.request.contextPath}/admin/cart/submitQuantity"
														method="post">
														<input type="hidden" name="id" value="${item.product.id }" />
														<input type="number" name="quantity"
															value="${item.quantity }"
															max="${item.product.inventory }" min="1" /> <input
															class="btn animate" type="submit" value="Change" />
													</form>
												</td>

												<td class="total-amount" data-title="Total"><span>
														${(item.quantity) * (item.unitPrice)}</span></td>

												<td class="action" data-title="Remove"><a
													href="${pageContext.request.contextPath}/admin/cart/deleteOrderDetails?id=${item.product.id }"><i
											...
											<sec:authorize access="hasRole('CUSTOMER')">
												...
												<td class="qty" data-title="Qty">
													<form
														action="${pageContext.request.contextPath}/customer/cart/submitQuantity"
														method="post">
														<input type="hidden" name="id" value="${item.product.id }" />
														<input type="number" name="quantity"
															value="${item.quantity }"
												...
												<td class="action" data-title="Remove"><a
													href="${pageContext.request.contextPath}/customer/cart/deleteOrderDetails?id=${item.product.id }"><i
														class="ti-trash remove-icon"></i></a></td>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									...
									<ul>
										<li>Cart Subtotal<span>$ ${orderPrice }</span></li>
										<li>Shipping<span>Free</span></li>
										<li>You Save<span>$ ${savedPrice }</span></li>
										<li class="last">You Pay<span>$
												${orderDiscountPrice }</span></li>
									</ul>
