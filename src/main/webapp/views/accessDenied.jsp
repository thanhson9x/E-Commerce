							...
							<div class="all-category">
								...
								<sec:authorize access="hasRole('ADMIN')">
									...
									<ul class="main-category">
										<li><a
											href="${pageContext.request.contextPath}/admin/allOrders">View
												All Orders </a></li>
										<li class="main-mega"><a href="#">Shipping </a></li>
										...
										<li><a href="#">User <i class="fa fa-angle-right"
												aria-hidden="true"></i>
										</a>
											<ul class="sub-category">
												<li><a
													href="${pageContext.request.contextPath}/admin/allUsers">View
														All Users</a></li>
												<li><a
									...
									<div class="navbar-collapse">
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
												...
												<sec:authorize access="hasRole('ADMIN')">
													<li class="active"><a
														href="${pageContext.request.contextPath}/admin/info">Home</a></li>
													<li><a
												...
												<sec:authorize access="hasRole('CUSTOMER')">
													<li class="active"><a
														href="${pageContext.request.contextPath}/customer/info">Home</a></li>
													<li><a
			...
			<div class="row">
				...
				<div class="col-lg-9 col-12">
					<div class="checkout-form">
						<h2 style="color: red">You are NOT authorized to access this
							page</h2>
