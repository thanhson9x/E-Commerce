			...
			<div class="row">
				<div class="col-12">
					<div class="checkout-form">
						<h2 style="color: red">Congratulations! Your order is
							accepted!</h2>
						<p>Your orders are processed and shipped within 3-5 business
							days</p>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-12">
								<div class="form-group">
									...
									<c:choose>
										<c:when
											test="${order.orderDetails ne null && order.orderDetails.size() gt 0}">
											<c:forEach items="${order.orderDetails }" var="item">
												<p>
													...
													<br> $ ${item.unitPrice } x ${item.quantity }
												</p>
											</c:forEach>
										</c:when>
										<c:otherwise>
