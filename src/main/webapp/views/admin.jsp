				...
				<div class="col-lg-9 col-12">
					...
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li><a href="${pageContext.request.contextPath}/admin/form">Admin<i
									class="ti-arrow-right"></i></a></li>
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/allAdmins">All
									Admins</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-9 col-12">
					...
					<div class="checkout-form">
						...
						<p>You can submit your info here!</p>
						...
						<form:form class="form"
							action="${pageContext.request.contextPath}/admin/submit"
