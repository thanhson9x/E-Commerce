						...
						<ul class="bread-list">
							...
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/discount">Discount<i
									class="ti-arrow-right"></i></a></li>
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/allDiscounts">All
									Discounts</a></li>
						</ul>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-8 col-12">
					<div class="checkout-form">
						<h2>This is Discount Page</h2>
						<p>You can submit your product's discount here!</p>
						...
						<form:form class="form"
							action="${pageContext.request.contextPath}/admin/submitDiscount"
							...
							<div class="row">
								...
								<%-- <div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
										<label>Date start<span>*</span></label>
										<form:input type="date" path="dateStart" required="required" />
								...
								<div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
										<label>Date end<span>*</span></label>
										<form:input type="date" path="dateEnd" required="required" />
								...
								<div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
										...
										<form:input type="number" path="discountPercentage" max="100"
											min="0" required="required" />
										<form:errors path="discountPercentage" cssClass="error" />
									</div>
								</div>
