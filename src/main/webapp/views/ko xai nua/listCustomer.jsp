					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar shopping">
								<a href="${pageContext.request.contextPath}/admin/cart" class="single-icon"><i class="ti-bag"></i> <span
									...
									<div class="navbar-collapse">
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
												...
												<li><a
													href="${pageContext.request.contextPath}/admin/allDiscounts">SALE
														OFF</a></li>
					...
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li><a href="${pageContext.request.contextPath}/admin/info">Admin<i
									class="ti-arrow-right"></i></a></li>
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/customer">Customer</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<c:choose>
								<c:when
									test="${listCustomer ne null && listCustomer.size() gt 0}">
									<c:forEach items="${listCustomer }" var="item">
										<tr>
											...
											<td class="total-amount" data-title="Total"><a
												href="${pageContext.request.contextPath}/admin/updateCustomer?id=${item.id }">Update</a></td>
											<td class="action" data-title="Remove"><a
												href="${pageContext.request.contextPath}/admin/deleteCustomer?id=${item.id }"><i
