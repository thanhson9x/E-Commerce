										...
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
												...
												<li><a href="#">Blog<i class="ti-angle-down"></i></a>
													<ul class="dropdown">
														<li><a href="${pageContext.request.contextPath}/admin/blog">Blog Single Sidebar</a></li>
													</ul></li>
												<li><a
			...
			<div class="row">
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<c:choose>
								<c:when test="${listAdmin ne null && listAdmin.size() gt 0}">
									<c:forEach items="${listAdmin }" var="item">
										<tr>
											...
											<td class="total-amount" data-title="Total"><a
												href="${pageContext.request.contextPath}/admin/updateAdminForm?id=${item.id }">Update</a></td>
											<c:if test="${item.id ne '1'}">
												<td class="action" data-title="Remove"><a
													href="${pageContext.request.contextPath}/admin/deleteAdmin?id=${item.id }"><i
