			...
			<div class="row">
				<div class="col-lg-8 col-12">
					<div class="checkout-form">
						...
						<p>You can change your order here!</p>
						...
						<form:form class="form"
							action="${pageContext.request.contextPath}/admin/cart/updateOrderDetails"
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
										...
										<form:input path="orderDetails.product.name" readonly="true" />
										<form:errors path="orderDetails.product.name" cssClass="error" />
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
										...
										<form:input type="number" path="unitPrice" readonly="true" />
