									...
									<c:forEach items="${listCategory }" var="item">
										<tr>
											...
											<td class="total-amount" data-title="Total"><a
												href="${pageContext.request.contextPath}/admin/updateCategory?id=${item.id }">Update</a></td>
											<td class="action" data-title="Remove"><a
												href="${pageContext.request.contextPath}/admin/deleteCategory?id=${item.id }"><i
