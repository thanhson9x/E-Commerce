			...
			<div class="row">
				<div class="col-lg-8 col-12">
					<div class="checkout-form">
						...
						<p>Please comfirm your info in order to checkout</p>
						...
						<sec:authorize access="hasRole('ADMIN')">
							<form:form class="form"
								action="${pageContext.request.contextPath}/admin/doCheckout"
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<label>Payments<span style="color: red;">*</span></label><br>
										<input name="payment" id="cod" type="radio" value="cod"
											required="required"> <label for="cod"> Cash
											On Delivery</label><br> <input name="payment" id="credit"
											type="radio" value="credit" required="required"> <label
						...
						<sec:authorize access="hasRole('CUSTOMER')">
							<form:form class="form"
								action="${pageContext.request.contextPath}/customer/doCheckout"
								method="post" modelAttribute="user">
								<div class="row">
