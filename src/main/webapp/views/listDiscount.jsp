					...
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li><a href="${pageContext.request.contextPath}/admin/info">Admin<i
									class="ti-arrow-right"></i></a></li>
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/discount">Discount</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<c:choose>
								<c:when
									test="${listDiscount ne null && listDiscount.size() gt 0}">
									<c:forEach items="${listDiscount }" var="item">
										<tr>
											...
											<%-- <td class="price" data-title="Price"><span>${item.dateStart
											}
											</span></td>
											<td class="price" data-title="Price"><span>${item.dateEnd
											}
											</span></td> --%>
											<td class="price" data-title="Price"><span>${item.discountPercentage
											}
											</span></td>
											<td class="total-amount" data-title="Total"><a
												href="${pageContext.request.contextPath}/admin/updateDiscount?id=${item.id }">Update</a></td>
											<td class="action" data-title="Remove"><a
												href="${pageContext.request.contextPath}/admin/deleteDiscount?id=${item.id }"><i
