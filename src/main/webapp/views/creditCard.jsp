					...
					<div class="checkout-form">
						...
						<sec:authorize access="hasRole('ADMIN')">
							<form:form class="form"
								action="${pageContext.request.contextPath}/admin/payment"
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Card Number<span>*</span></label> <input type="number"
												name="cardNumber" placeholder="XXX... (16 digits)"
												required="required" />
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>CVV<span>*</span></label> <input type="number"
												name="cvv" placeholder="XXX" required="required" />
											<form:errors path="cardNumber" cssClass="error" />
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Expiration date<span>*</span></label> <input
												type="text" name="expirationDate" placeholder="MM/DD"
												required="required" />
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>PIN<span>*</span></label> <input type="number"
												name="pin" placeholder="XXXXXX" required="required" />
						...
						<sec:authorize access="hasRole('CUSTOMER')">
							<form:form class="form"
								action="${pageContext.request.contextPath}/customer/payment"
								method="post" modelAttribute="creditCard">
								<div class="row">
				...
				<div class="col-lg-4 col-12">
					<div class="order-details">
						...
						<div class="single-widget">
							...
							<div class="content">
								<ul>
									<li>Sub Total<span>$ ${orderDiscountPrice }</span></li>
									<li>(+) Shipping<span>FREE</span></li>
									<li class="last">Total<span>$ ${orderDiscountPrice }</span></li>
								</ul>
							</div>
						</div>
						<!--/ End Order Widget -->
