					...
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li><a href="${pageContext.request.contextPath}/admin/info">Admin<i
									class="ti-arrow-right"></i></a></li>
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/category">Category<i
									class="ti-arrow-right"></i></a></li>
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/allCategories">All
									Categories</a></li>
						</ul>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-8 col-12">
					<div class="checkout-form">
						...
						<p>You can submit your product's category here!</p>
						...
						<form:form class="form"
							action="${pageContext.request.contextPath}/admin/submitCategory"
